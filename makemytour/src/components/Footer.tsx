    ...
    <footer className="bg-black text-gray-300 pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Established in 2000, MakemyTour has since positioned itself as of
              the leading companies, providing great offers, competitive
              airfarers, exclusive discounts, and a seamless online bookingtype
              experience.
            </p>
          </div>
          <div>
            ...
            <p className="text-sm leading -relaxed">
              Book your flights tickets with India's leading flight bookingtype
              company. Get best deals on flights, train tickets, buses,
              hotelsand holiday packages.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-bold mb-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <h4 className="font-semibold mb-3">IMPORTNANT LINKS</h4>
            <ul className="text-sm space-y-2">
              <li>
                <a href="#" className="hover:text-white">
                  Privacy Policy
