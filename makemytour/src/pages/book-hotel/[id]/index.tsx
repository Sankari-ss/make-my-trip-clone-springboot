...
const BookHotelPage = () => {
  ...
  useEffect(() => {
    const fetchHotel = async () => {
      try {
        ...
        const filtereddata = data.filter((hotels: any) => hotels.id === id);
        setHotel(filtereddata);
      } catch (error) {
  ...
  const handleQuantityChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setQuantity(
      isNaN(value) ? 1 : Math.max(1, Math.min(value, hotels.availableRooms))
    );
  };
  ...
  const totalPrice = hotels?.pricePerNight * quantity;
  const totalTax = hotelData.room?.taxes * quantity;
  const totalDiscount = hotelData.room?.discountPrice * quantity;
      ...
      <div className="grid gap-6 mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="hotelName" value={hotels.hotelName} readOnly />
          </div>
          <div className="space-y-2">
            ...
            <Input id="location" value={hotels.location} readOnly />
          </div>
          <div className="space-y-2">
            ...
            <Input id="pricePerNight" value={hotels.pricePerNight} readOnly />
          </div>
          <div className="space-y-2">
        ...
        <div className="bg-gray-100 rounded-lg p-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <span text-gray-600>Base Fare</span>
              <span className="font-medium">
                ₹ {totalPrice.toLocaleString()}
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span text-gray-600>Taxes and ExtraCharges</span>
              <span className="font-medium">₹ {totalTax.toLocaleString()}</span>
            </div>
            <div className="flex justify-between items-center text-green-600">
              <span text-gray-600>Discounts</span>
              <span className="font-medium">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <ChevronRight className="w-4 h-4 text-gray-400" />
            <span className="text-gray-600">{hotels?.hotelName}</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {/*Hotel Title & Rating */}
            <div className="mb-6">
              <h1 className="text-2xl font-bold mb-2">{hotels?.hotelName}</h1>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="mb-6">
                ...
                {/* Amenities */}
                <div>
                  <h4 className="text-gray font-semibold mb-2">Amenities :</h4>
                  <p className="text-gray-600">{hotels?.amenities}</p>
                </div>
              </div>
