...
const mockFlights = [
  {
    ...
    from: "New York",
    to: "London",
    departureTime: "2023-07-01T08:30",
...

  {
    ...
    from: "Paris",
    to: "Tokyo",
    departureTime: "2023-07-02T10:40",
...

  {
    ...
    from: "Los Angels",
    to: "Sydney",
    departureTime: "2023-07-03T22:15",
...
const mockHotels = [
  {
    ...
    pricePerNight: 300,
    availableRooms: 50,
    amenities: "wi-fi, pool, Spa, Restaurent",
  },

  {
    ...
    pricePerNight: 200,
    availableRooms: 100,
    amenities: "Bech Access, wi-fi, Restaurent, Water Sports",
  },

  {
    _id: "3",
    hotelName: "Mountain Lodge Palace",
    location: "Aspen, Colorado",
    pricePerNight: 250,
    availableRooms: 30,
    amenities: "Ski-in/Ski-out,FirePlace, Hot Tub, Restaurent",
  },
];
        ...
        <TabsContent value="hotels">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add, edit or remove hotles from the system
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 gap-4">
...
function Addeditflight({ flight }: { flight: Flight | null }) {
  ...
  const handlesumbit = async (e: React.FormEvent) => {
    ...
    console.log("Submiting flight data:", formData);
